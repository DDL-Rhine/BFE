# DES-go: BFE Scheduler Go Implementation
...
*   **cases\_path**: Specify the dataset path

*   **reports\_path**: Specify the experimental results output path

*   **workload**: Workload type, options are "light" or "heavy"

*   **number\_of\_jobs**: Job quantity range, containing two integers forming a range
